-- Update the handle_new_user function to also link employee records during preboarding signup
...
BEGIN
  ...
  IF existing_profile_id IS NOT NULL THEN
    ...
    -- CRITICAL FIX: Also update the employees table to link the user_id
