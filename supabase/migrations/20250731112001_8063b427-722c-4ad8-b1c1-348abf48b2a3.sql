-- Fix organization_id assignment in user_roles table
-- Update the update_onboarding_status function to set organization_id immediately when profile gets one
...
-- Also update the assign_organization_role function to ensure it properly sets organization_id
