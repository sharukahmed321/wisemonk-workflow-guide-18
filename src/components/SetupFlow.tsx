      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-muted-foreground">This agreement establishes clear terms on payments, compliance, and confidentiality, ensuring transparency and legal protection. </p>
          </CardHeader>
