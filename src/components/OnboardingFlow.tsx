...
import { createNameValidator, createJobTitleValidator, createBusinessNameValidator, createDropdownValidator, EMPLOYEE_COUNTS, COUNTRIES } from '@/lib/validationUtils';
...
export function OnboardingFlow({
  ...
  return <div className="flex-1 flex flex-col justify-center px-6 py-8 lg:px-8">
      <div className="mx-auto w-full max-w-md">
        {currentStep === 1 && <UserDetailsStep onNext={handleNext} userData={userData} setUserData={setUserData} />}
        {currentStep === 2 && <CompanyDetailsStep onNext={handleNext} onBack={handleBack} companyData={companyData} setCompanyData={setCompanyData} />}
        {currentStep === 3 && <SetupCompleteStep onComplete={onComplete} />}
      </div>
    </div>;
}
  ...
  return <div className="space-y-6">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <Button type="submit" disabled={isSubmitting} className="w-full h-11 mt-6">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          field
                ...
                <FormControl>
                  <CountrySelect value={field.value} onValueChange={field.onChange} placeholder="Select your country" className="h-11" />
                </FormControl>
                <FormMessage />
              </FormItem>} />
