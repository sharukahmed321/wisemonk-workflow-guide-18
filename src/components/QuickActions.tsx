...
export function QuickActions() {
  ...
  const filteredActions = actions.filter(action => 
    !action.permission || action.permission(permissions)
  );
              ...
              <TooltipTrigger asChild>
                <Button
                  ...
                  className={`
                    ...
                    ${action.primary 
                      ? 'bg-gradient-to-br from-primary/10 to-primary/5 hover:from-primary/15 hover:to-primary/8 ring-1 ring-primary/20' 
                      : `bg-gradient-to-br ${action.gradient || 'from-muted/50 to-muted/20'} hover:from-muted/70 hover:to-muted/30`
                    }
