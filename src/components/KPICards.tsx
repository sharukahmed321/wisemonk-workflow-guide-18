        ...
        >
          ...
          <CardContent className="p-5 pt-0">
            <div className="space-y-0.5">
              ...
              <div className={`text-xs flex items-center gap-1 font-medium ${getTrendColor(kpi.trend)}`}>
                {getTrendIcon(kpi.trend)}
                <span className="font-semibold">{kpi.changeValue}</span>
                <span className="text-muted-foreground font-normal">{kpi.change}</span>
              </div>
            </div>
          </CardContent>
        </Card>
